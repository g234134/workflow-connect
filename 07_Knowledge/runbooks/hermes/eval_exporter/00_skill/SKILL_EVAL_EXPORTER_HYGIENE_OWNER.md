# SKILL_EVAL_EXPORTER_HYGIENE_OWNER.md

> 身份：eval_exporter 模組之基礎設施衛生負責人（Infra Hygiene Owner）
...
Infra Hygiene Owner 負責 eval_exporter 模組的非功能性基礎設施品質：
...
| 觸發事件 | 行動 |
|----------|------|
| 新 PR / 合併請求涉及 eval_exporter | 執行 §2 完整檢查清單 |
