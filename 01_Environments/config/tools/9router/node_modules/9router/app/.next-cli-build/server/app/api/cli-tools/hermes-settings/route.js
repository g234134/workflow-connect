...
${b}
`:`${d}${b}
`);await i().writeFile(r(),c)}return e.NextResponse.json({success:!0,message:"Hermes settings applied successfully!",configPath:q()})}catch(a){return console.log("Error updating hermes settings:",a),e.NextResponse.json({error:"Failed to update hermes settings"},{status:500})}}async function y(){try{let a=q(),b="";try{b=await i().readFile(a,"utf-8")}catch(a){if("ENOENT"===a.code)return e.NextResponse.json({success:!0,message:"No config file to reset"});throw a}let c=b.replace(s,"").replace(/^\n+/,"");return await i().writeFile(a,c),e.NextResponse.json({success:!0,message:"9router model block removed"})}catch(a){return console.log("Error resetting hermes settings:",a),e.NextResponse.json({error:"Failed to reset hermes settings"},{status:500})}}(0,n.D)([w,x,y]),(0,d.A)(w,"0001c521fdd02397615965e5bd40fc13b383af728f",null),(0,d.A)(x,"40442b9f999037dd4b5d685d618e2f3c323af7460e",null),(0,d.A)(y,"0021129e38a71abee932b4ee99e291317938611afa",null)},63033:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},64749:()=>{},71266:(a,b,c)=>{"use strict";Object.defineProperty(b,"A",{enumerable:!0,get:function(){return d.registerServerReference}});let d=c(92713)},79646:a=>{"use strict";a.exports=require("child_process")},79748:a=>{"use strict";a.exports=require("fs/promises")},86439:a=>{"use strict";a.exports=require("next/dist/shared/lib/no-fallback-error.external")},92713:(a,b,c)=>{"use strict";a.exports=c(31975).vendored["react-rsc"].ReactServerDOMWebpackServer}};var b=require("../../../../webpack-runtime.js");b.C(a);var c=b.X(0,[7773,6799],()=>b(b.s=48321));module.exports=c})();