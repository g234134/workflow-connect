# TICKET STATE · FP-G3-T3-langfuse-pg-alignment-deferred-index-v1 · Langfuse/PG deferred 索引
...
- Goal: 索引 Langfuse／PG 對齊 deferred 項與解阻條件（≠ 真接 Langfuse）。
- Scope:
  - MUST：新建 `docs/langfuse-pg-alignment-deferred-index-v1.md`
...
- NonScope:
  ...
  - Phase%
- AllowedPaths:
  - `docs/langfuse-pg-alignment-deferred-index-v1.md`
  - `04_Workflows/tickets/FP-G3-T3-langfuse-pg-alignment-deferred-index-v1_state.md`（B/C/D_REPORT）
  - `docs/index.md`（MAY）
...
- AcceptanceCriteria:
  - AC-1：Landed + Deferred + 解阻清單
  - AC-2：non_claims 含 ≠ 真接 Langfuse
  - AC-3：rg 命中 Langfuse|deferred|non_claims
...
- status_by_role:
  ...
  - scribe: done
- orch_notes: >-
  Batch-3 execute · FP-G3-T3-langfuse-pg-alignment-deferred-index-v1 doc/spec 同輪 O→B→C→D 收口。串行 T1 後交付；仍 ≠ 真接。
- reviewer_notes: >-
...
- changed_files:
  - docs/langfuse-pg-alignment-deferred-index-v1.md（新建）
  - 04_Workflows/tickets/FP-G3-T3-langfuse-pg-alignment-deferred-index-v1_state.md
- artifacts:
  - docs/langfuse-pg-alignment-deferred-index-v1.md
- verification:
  - cmd: `rg "Langfuse|deferred|non_claims|gov-trace|解阻" docs/langfuse-pg-alignment-deferred-index-v1.md`
...
- docs_updates:
  ...
  - docs/index.md（MAY）
- progress_entry: |
  2026-07-10 · FP-G3-T3-langfuse-pg-alignment-deferred-index-v1 done · Langfuse/PG deferred 索引 · Reviewer accepted · branch_ai_closed ≠ Phase closure
