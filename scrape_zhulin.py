#!/usr/bin/env python3
"""Scrape ALL 纣临 chapters from piaotia.com (full series)."""
import requests
import re
import os
import time
...
BASE_URL = "https://www.piaotia.com/html/9/9270/"
OUTPUT_DIR = "C:/Users/666LAG/OneDrive/文件/Obsidian Vault/Novels/纣临/chapters"
...
def get_chapter_list():
    ...
    resp.encoding = 'gbk'
    soup_text = resp.text
    # Extract chapter links using regex (they look like "6130638.html")
    ...
    for i, (chapter_id, title) in enumerate(chapters):
        ...
        if content and len(content) > 100:
            ...
            with open(filepath, 'w', encoding='utf-8') as f:
                ...
                f.write("tags: [纣临]\n")
                f.write("date: 2026-07-29\n")
                f.write("---\n\n")
                f.write(f"# {title}\n\n")
                f.write(content)
                f.write("\n\n---\n\n")
                f.write("## 📖 相关链接\n\n")
                f.write("- [[index|纣临索引]] — 返回主索引\n")
                f.write("- [[纣临_完整时间线_001-100|完整时间线]] — 查看时间线\n")
